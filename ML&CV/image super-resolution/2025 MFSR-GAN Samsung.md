...
---
原文：MFSR-GAN: Multi-Frame Super-Resolution with Handheld Motion Modeling
本文主要针对智能手机的多帧超分问题。
![[attachments/Pasted image 20260427173328.png]]
# MFSR-GAN 整体架构解读
模型输入是手持智能手机拍摄的多帧低分辨率（LR）RAW 图像，输出一张高分辨率（HR）RGB 图像。整个流程分为四个大模块。
...
该模块通过通道注意力机制（[[../nn积木/SE Squeeze-and-Excitation (Channel Attention)|SE Squeeze-and-Excitation (Channel Attention)]]）跨帧整合信息，结合残差连接，提升感知质量。具体来说：
