...
update: 2026-07-21
---
原文：Squeeze-and-Excitation Networks，简称SE。也常常被称为通道注意力，channel attention
**CNN 问题**：传统的CNN擅长通过卷积操作捕捉空间模式，但它们隐含地处理通道依赖性，限制了它们根据任务的重要性自适应地强调或抑制特征的能力。
**SE改进**，实现了：
- 网络自己判断哪些通道重要
- 重要通道放大
- 不重要通道压低
...
2. **激励**： 
   ...
   数学公式表示为：  $$s = F_{ex}(z,W) = \sigma(W_2 \delta(W_1 z))$$其中：
