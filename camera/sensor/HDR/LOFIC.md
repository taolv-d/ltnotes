...
LOFIC 目的是增加动态范围。限1制动态范围的两个因素是：1 本底噪声，2 满阱容量。噪声这里的控制已经很难在提升，因此Lofic技术是进一步提升动态范围的主力。（更进一步提升则是TTS）
...
另外，LCG 转换这里用了更大的电容，那么转换增益会变小，后级用同一个ADC 采样，对应这里的分辨率势必会更低。不过这刚好与人眼特性匹配上了（人对亮度的变化是波动超过1%才能察觉，对应亮区需要亮度变化很大人眼才能感知，参考[[../../optics/color/Color science and digital image（影视从业者对色彩的理解）|Color science and digital image（影视从业者对色彩的理解）]]）。因此LOFIC这里降低分辨率实际影响并不大。
