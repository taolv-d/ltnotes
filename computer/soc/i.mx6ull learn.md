...
![img](../../image/file-permissions-rwx.jpg)

只有文件所有者和超级用户可以修改文件或目录的权限。可以使用绝对模式（八进制数字模式），符号模式指定文件的权限。

![img](../../image/rwx-standard-unix-permission-bits.png)
...
![image-20240704002431085](../../image/image-20240704002431085.png)
...
![image-20240714220619184](../../image/image-20240714220619184.png)

![image-20240714220715061](../../image/image-20240714220715061.png)
...
![image-20240714182020869](../../image/image-20240714182020869.png)
...
![请添加图片描述](../../image/b1f2db04adac4081aafe2f3fd8209c99.png)
用0和1来代表灭和亮（阳码)，越靠近**上方**的是低位

![在这里插入图片描述](../../image/c0f7853b338d4100ac3069255cf755ec.png)

> 左边的实际的点阵，右边是等效的数，这样编码之后的这页这列的值为0x05

![请添加图片描述](../../image/43abae557c314f328fe590f0a10ca859.png)
...
![请添加图片描述](../../image/ea53da2dfd3a4afa8ec22b01f7df3628.png)

![在这里插入图片描述](../../image/88dcd2b0b70d49d2a21f91f424a4cf82.png)
...
![image-20240714214647686](../../image/image-20240714214647686.png)

具体接法参考下面的：

![image-20240714214926158](../../image/image-20240714214926158.png)
...
![image-20240714215159912](../../image/image-20240714215159912.png)
